...
@EnableWs
@Configuration
public class MailConfig extends WsConfigurerAdapter {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema mailSchema) {
		...
		wsdl11Definition.setPortTypeName("Mail");
		wsdl11Definition.setLocationUri("/ws");
		wsdl11Definition.setTargetNamespace("http://www.example.org/wsmail");
